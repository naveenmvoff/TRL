    ...
    <div className="p-6 bg-secondary min-h-full">
      ...
      <div className="bg-white rounded-md p-6 mb-4 shadow-sm">
        ...
        <div className="space-y-2 text-sm">
          <div className="flex">
            <span className="text-gray-600 font-semibold w-32">Manager Email :</span>
            <span className="text-gray-800">{email}</span>
          </div>
          <div className="flex">
            <span className="text-gray-600 font-semibold w-32">Factory Number :</span>
          ...
          productsData.map((item, index) => (
            ...
            >
              <div className="flex justify-between py-2 items-center">
                <div className="pr-2">
                  <h3 className="font-semibold text-gray-800">{item.product || 'No Product Name'}</h3>
