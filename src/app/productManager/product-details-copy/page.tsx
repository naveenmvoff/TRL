...
// Using Lucide React icons which come with Next.js
    ...
    <div className="bg-slate-100 min-h-screen p-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-md p-6 mb-4 shadow-sm">
          <h2 className="font-medium mb-4">Hello, {userName}</h2>
        ...
        <div className="bg-white rounded-md p-6 shadow-sm">
          {techFlowItems.map((item, index) => (
            <div key={item.id}>
              ...
              {index < techFlowItems.length - 1 && <div className="border-b border-gray-200"></div>}
            </div>
          ))}
        </div>
      </div>
...
export default function Page() {
  ...
  return <ProductDetails userName="John Doe" email="johndoe@abcd.com" factoryNumber="1" techFlowItems={techFlowItems} />
}
